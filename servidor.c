...
int main()
{
  ...
  verify_error(server_socket_number, "socket");
  ...
  verify_error(bind_number, "bind");

  int listen_number = listen(server_socket_number, SERVER_MAX_CONNECTIONS);
  verify_error(listen_number, "listen");

  struct sockaddr_in client_socket_address;

  int accept_number = accept(server_socket_number, (struct sockaddr *)&client_socket_address, sizeof(client_socket_address));
  verify_error(accept_number, "accept");
